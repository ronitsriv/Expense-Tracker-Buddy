...
INSERT INTO amount (amount_id, amount, entry_date, reason, username, category_id) VALUES (3, 250, CURRENT_DATE(), 'A Bill', 'John Doe', 2);
...
INSERT INTO category_wise_budget (cat_wiseid, budget, username, category_id) VALUES (2, 300, 'John Doe', 2);
